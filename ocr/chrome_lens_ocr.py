...
class ChromeLensOCR:
    ...
    def _preprocess_image(self, image: Image.Image) -> Image.Image:
        """
        Preprocess bubble image to improve OCR robustness on ugly / noisy fonts.
        
        - Convert to grayscale
        - Upscale small bubbles (so thin fonts are clearer)
        - Auto-contrast to boost text/background separation
        - Light sharpening to make strokes crisper
        """
        ...
        # Auto contrast + slight sharpening
    ...
    def __call__(self, image) -> str:
        ...
        # Robust pre-processing to handle ugly fonts / low-quality scans
    ...
    def process_batch(self, images: list) -> list:
        ...
        """
        # Convert numpy arrays to PIL Images and preprocess each bubble
        pil_images = []
        for img in images:
            if isinstance(img, np.ndarray):
                ...
                pil = img
            pil_images.append(self._preprocess_image(pil))
